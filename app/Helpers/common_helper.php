...
if (!function_exists('showPaymentStatus')) {
	...
	{
		$statusArray = array(
			'N' => '<label class="badge badge-light-danger">' . lang('statictext_lang.pending') . '</label>',
...
if (!function_exists('showAcountVerifiedStatus')) {
	...
	{
		$statusArray = array(
			'N' => '<label class="badge badge-light-danger">' . lang('statictext_lang.account_pending') . '</label>',
...
if (!function_exists('showPropertyStatus')) {
	...
	{
		$statusArray = array(
			'p' => '<label class="badge badge-light-danger">' . lang('statictext_lang.property_pending') . '</label>',
...
if (!function_exists('showPaymentStatusSimple')) {
	...
	{
		$statusArray = array(
			'0' => lang('statictext_lang.initialize'),
...
if (!function_exists('showApproveStatus')) {
	...
	{
		$statusArray = array(
			'A' => '<label class="badge badge-light-success">' . lang('statictext_lang.publish') . '</label>',
...
if (!function_exists('showAccountActiveStatus')) {
	...
	{
		$statusArray = array(
			'1' => '<label class="badge badge-light-success">' . lang('statictext_lang.login') . '</label>',
...
if (!function_exists('adminPagination')) {
	function adminPagination($url = '', $suffix = '', $rowsCount = 0, $perPage = 10, $uriSegment = 0)
	{
		...
		return $pager->makeLinks($uriSegment, $perPage, $rowsCount, 'admin_pagination');
	}
}
